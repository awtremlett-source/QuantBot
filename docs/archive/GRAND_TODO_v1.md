# GRAND_TODO v1 — ARCHIVED 2026-09-21 (quarantine, never delete)

This is the v1 backlog exactly as it stood at commit 8a81c6a, kept whole for
the record. The direction changed on 2026-09-21: see docs/plan/PLAN_V2.md.

v1 itself KEEPS RUNNING, untouched. Rows here that are still true of the live
v1 engine were carried across to the new GRAND_TODO.md; nothing was deleted.
